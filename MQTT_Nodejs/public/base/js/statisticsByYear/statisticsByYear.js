...
function loadDataTableTemp() {
  ...
  async function getDataTemp() {
    const response = await fetch('/api/statisticsByYear/Temp');
...
async function getDataTemp1() {
  const response = await fetch('/api/statisticsByYear/Temp2');
  const data = await response.json();
  rss = data[0];
  oke1 = rss.map((x) => `<tr>
            <th scope="row">${x.id}</th>
...
function loadDataTableHum() {
  ...
  async function getDataHum() {
    const response = await fetch('/api/statisticsByYear/Hum');
    const data = await response.json();
...
async function getDataHum1() {
  const response = await fetch('/api/statisticsByYear/Hum2');
  const data = await response.json();
  rss = data[0];
  oke1 = rss.map((x) => `<tr>
            <th scope="row">${x.id}</th>
...
function loadDataTableSoi() {
  ...
  async function getDataSoi() {
    const response = await fetch('/api/statisticsByYear/Soi');
    const data = await response.json();
...
async function getDataSoi1() {
  const response = await fetch('/api/statisticsByYear/Soi2');
  const data = await response.json();
  rss = data[0];
  oke1 = rss.map((x) => `<tr>
            <th scope="row">${x.id}</th>
...
function loadDataTableLight() {
  ...
  async function getDataLight() {
    const response = await fetch('/api/statisticsByYear/Light');
    const data = await response.json();
...
function loadDataTableRain() {
  ...
  async function getDataRain() {
    const response = await fetch('/api/statisticsByYear/Rain');
    const data = await response.json();
